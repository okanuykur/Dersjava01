...
public class C01_0rtalamaninUstundekiNotlar {

    public static void main(String[] args) {
        // ogretmenden ogrenci notlarini alin
        // sonra bir list olusturun
        //ogretmen q ya basip bitirdiginde
        //sinif sayisini, sinif ortalamasini ve kac kisinin ortalamanin ustunde  not aldigini yazin
    ...
    public static List<Double> listeOlustur(){
        ...
        while (girilenNot<=100){
            System.out.println("lutfen listeye eklemek icin not girin+" +
